...
def upgrade() -> None:
    ...
    sa.Column('frequency_unit', sa.Enum('daily', 'weekly', name='frequencyunit'), nullable=False),
    ...
    op.create_index('ix_habit_logs_habit_id_completed_at', 'habit_logs', ['habit_id', 'completed_at'])
